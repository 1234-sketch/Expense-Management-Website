                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            <input type="date" class="form-control sample_class" id="from" name="from" min="2020-12-15" max="2030-12-15" required="true">
                                           
                                        </div>
                                        <div class="col-xs-6">
                                            <label for="to">To</label>
                                            <input type="date" class="form-control sample_class" id="to" name="to" min="2020-12-15" max="2030-12-15"required="true" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
